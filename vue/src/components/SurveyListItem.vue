<template>
    <div  :key="survey.id"
            ...
            <img :src='survey.image_url' class="w-full h-48 object-cover" alt=''>
            ...
            <div class="flex justify-between items-center mt-3">
              ...
              <button v-if="survey.id" @click="emits('delete',survey)"
                class="h-8 w-8 flex items-center justify-center rounded-full border border-transparent text-sm text-red-500 focus:ring-2 focus:ring-offset-2 focus:ring-red-500"><svg
