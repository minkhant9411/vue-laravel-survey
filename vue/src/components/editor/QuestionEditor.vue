<template>
  ...
  <div class="grid gap-3 grid-cols-12">
    ...
    <div class="mt-3 col-span-9">
      <label :for="'question_text_' + questionData.data" class="block text-sm font-medium text-gray-700">Question
        Text</label>
      <input type="text" :name="'question_text_' + questionData.data" v-model="questionData.question" @change="dataChange"
    ...
    <div class="mt-3 col-span-3">
      ...
      <select id="question_type" name="question_type" v-model="questionData.type" @change="typeChange"
  ...
  <div class="mt-3 col-span-9">
    <label :for="'question_description_' + questionData.id"
      class="block text-sm font-medium text-gray-700">Description</label>
    <textarea :name="'question_description_' + questionData.id" v-model="questionData.description" @change="dataChange"
  ...
  <div>
    <div v-if="shouldHaveOptions()" class="mt-2">
      ...
      <!-- Option list -->
      <div v-for="(option, index) in questionData.data.options" :key="option.uuid" class="flex items-center mb-1">
